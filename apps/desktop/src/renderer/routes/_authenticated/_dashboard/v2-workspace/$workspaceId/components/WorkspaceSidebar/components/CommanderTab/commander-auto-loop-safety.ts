export type AutoLoopDangerousCommandSource =
	| "browser ai reply"
	| "worker report"
	| "actual shell command";

export interface AutoLoopDangerousCommandFinding {
	label: string;
	source: AutoLoopDangerousCommandSource;
	matchedText: string;
	reason: string;
	nextAction: string;
}
...
export function findAutoLoopDangerousCommandFinding(
	text: string,
	source: AutoLoopDangerousCommandSource = "browser ai reply",
): AutoLoopDangerousCommandFinding | null {
